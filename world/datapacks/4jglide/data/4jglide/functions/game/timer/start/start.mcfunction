...
function 4jglide:game/timer/start/count

##Freeze players in 10 ticks
schedule function 4jglide:game/setup/freeze/check 10t

##Disable Damage
function 4jglide:game/damage/disable

##Start showdown timer
function 4jglide:game/timer/showdown/start

##Load hunger
function 4jglide:game/hunger/start

##Enable small inventory if set to
execute if score #Store 4j.smallinv matches 1 run function 4jglide:game/inventory/start
...
##Copy mob head
execute as @a[tag=headstore] run function 4jglide:lobby/mobhead/copy

##Lock chests
schedule function 4jglide:game/chests/lock 1s