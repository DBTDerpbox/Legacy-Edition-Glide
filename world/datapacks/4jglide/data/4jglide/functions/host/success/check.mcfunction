##Menu
execute if score #Store 4j.gamestatus matches 0 run function 4jglide:host/success/menu

##Lobby
#execute if score #Store 4j.gamestatus matches 1 run function 4jglide:host/success/lobby
