...
execute if score #highestScore 4j.mapvote matches 0 run function 4jglide:mapdecider/randommap

##Find highest vote if votes were made
execute if score #highestScore 4j.mapvote matches 1.. run function 4jglide:mapdecider/findhighest

##Stop vote check
schedule clear 4jglide:mapdecider/vote/check
