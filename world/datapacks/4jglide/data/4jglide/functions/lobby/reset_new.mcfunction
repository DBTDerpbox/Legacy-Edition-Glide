...
#Nether tower
data merge block -371 55 -310 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_ward",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
...
#Water tower
data merge block -371 76 -372 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_far",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -339 48 -381 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_wait",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
#top right roof
data merge block -302 77 -317 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_mall",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
#Painting area
data merge block -302 58 -330 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_11",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
#Fish chest
data merge block -364 66 -327 {Items:[{Count:1b,Slot:4b,id:"minecraft:music_disc_mellohi",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
...
data merge block -328 56 -362 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_stal",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -324 58 -318 {Items:[{Count:1b,Slot:4b,id:"minecraft:music_disc_strad",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -341 70 -370 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_chirp",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -350 71 -312 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_cat",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -337 76 -311 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_blocks",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
data merge block -317 42 -328 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_13",tag:{CanPlaceOn:["#4jglide:all_blocks"],HideFlags:16}}]}
...
#Buttons room
function 4jglide:lobby/secret/zombiehead/reset
#Dragon room
